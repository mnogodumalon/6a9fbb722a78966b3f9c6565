...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['firmenname', { row: ['ansprechpartner_vorname', 'ansprechpartner_nachname'], cols: '1fr 1fr' }, { row: ['strasse', 'hausnummer'], cols: '2fr 1fr' }, { row: ['plz', 'ort'], cols: '1fr 2fr' }, 'email', 'telefon', 'zahlungsziel_tage', 'kreditlimit', 'bemerkung'],
  defaults: {},
  computed: {},
};
