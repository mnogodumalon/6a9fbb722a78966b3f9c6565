...
export const formEnhancements: FormEnhancements = {
  ...
  computed: {
    'mehrwertsteuerbetrag': { op: 'mul', left: { kind: 'field', key: 'nettobetrag' }, right: { kind: 'literal', value: 0.19 } },
    'bruttobetrag': { op: 'add', left: { kind: 'field', key: 'nettobetrag' }, right: { kind: 'field', key: 'mehrwertsteuerbetrag' } },
  },
};
