...
import type { Lieferanten, Kunden, Artikel, Auftraege, Auftragspositionen, Lieferantenbestellungen, Bestellpositionen, Lagerbewegungen, Rechnungen, Zahlungseingaenge, CreateLieferanten, CreateKunden, CreateArtikel, CreateAuftraege, CreateAuftragspositionen, CreateLieferantenbestellungen, CreateBestellpositionen, CreateLagerbewegungen, CreateRechnungen, CreateZahlungseingaenge } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async getLieferanten(): Promise<Lieferanten[]> {
    ...
    return hydrateRecords(records, 'lieferanten');
  }
  static async queryLieferanten(q: RecordQuery = {}): Promise<Lieferanten[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.LIEFERANTEN}/records${recordQueryString(q)}`, undefined, { signal: q.signal });
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Lieferanten[];
  ...
  static async countLieferanten(filter?: string, signal?: AbortSignal): Promise<number> {
    const data = await callApi('GET', `/apps/${APP_IDS.LIEFERANTEN}/aggregate_records${recordQueryString({ filter })}${filter ? '&' : '?'}value=count()`, undefined, { signal, silent: true });
  ...
  static async getLieferantenEntry(id: string): Promise<Lieferanten | undefined> {
    ...
    const record = { record_id: data.id, ...data, createdat: data.created_at ?? '', updatedat: data.updated_at ?? null } as Lieferanten;
    return hydrateRecords([record], 'lieferanten')[0];
  }
  static async createLieferantenEntry(fields: CreateLieferanten): Promise<MutationResult> {
    const data = await callApi('POST', `/apps/${APP_IDS.LIEFERANTEN}/records`, { fields: cleanFieldsForApi(fields as any, 'lieferanten') });
    return { ...data, record_id: data.id };
  }
  static async updateLieferantenEntry(id: string, fields: Partial<CreateLieferanten>): Promise<MutationResult> {
    const data = await callApi('PATCH', `/apps/${APP_IDS.LIEFERANTEN}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'lieferanten') });
    return { ...data, record_id: data.id };
  }
  ...
  static async getArtikel(): Promise<Artikel[]> {
    ...
    return hydrateRecords(records, 'artikel');
  }
  static async queryArtikel(q: RecordQuery = {}): Promise<Artikel[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.ARTIKEL}/records${recordQueryString(q)}`, undefined, { signal: q.signal });
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Artikel[];
  ...
  static async countArtikel(filter?: string, signal?: AbortSignal): Promise<number> {
    const data = await callApi('GET', `/apps/${APP_IDS.ARTIKEL}/aggregate_records${recordQueryString({ filter })}${filter ? '&' : '?'}value=count()`, undefined, { signal, silent: true });
    return parseAggregateCount(data);
  }
  static async getArtikelEntry(id: string): Promise<Artikel | undefined> {
    ...
    const record = { record_id: data.id, ...data, createdat: data.created_at ?? '', updatedat: data.updated_at ?? null } as Artikel;
    return hydrateRecords([record], 'artikel')[0];
  }
  static async createArtikelEntry(fields: CreateArtikel): Promise<MutationResult> {
    const data = await callApi('POST', `/apps/${APP_IDS.ARTIKEL}/records`, { fields: cleanFieldsForApi(fields as any, 'artikel') });
    return { ...data, record_id: data.id };
  }
  static async updateArtikelEntry(id: string, fields: Partial<CreateArtikel>): Promise<MutationResult> {
    const data = await callApi('PATCH', `/apps/${APP_IDS.ARTIKEL}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'artikel') });
    return { ...data, record_id: data.id };
  }
  ...
  static async getLieferantenbestellungen(): Promise<Lieferantenbestellungen[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.LIEFERANTENBESTELLUNGEN}/records`);
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Lieferantenbestellungen[];
    return hydrateRecords(records, 'lieferantenbestellungen');
  }
  static async queryLieferantenbestellungen(q: RecordQuery = {}): Promise<Lieferantenbestellungen[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.LIEFERANTENBESTELLUNGEN}/records${recordQueryString(q)}`, undefined, { signal: q.signal });
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Lieferantenbestellungen[];
  ...
  static async countLieferantenbestellungen(filter?: string, signal?: AbortSignal): Promise<number> {
    const data = await callApi('GET', `/apps/${APP_IDS.LIEFERANTENBESTELLUNGEN}/aggregate_records${recordQueryString({ filter })}${filter ? '&' : '?'}value=count()`, undefined, { signal, silent: true });
    return parseAggregateCount(data);
  }
  static async getLieferantenbestellungenEntry(id: string): Promise<Lieferantenbestellungen | undefined> {
    const data = await callApi('GET', `/apps/${APP_IDS.LIEFERANTENBESTELLUNGEN}/records/${id}`);
    const record = { record_id: data.id, ...data, createdat: data.created_at ?? '', updatedat: data.updated_at ?? null } as Lieferantenbestellungen;
    return hydrateRecords([record], 'lieferantenbestellungen')[0];
  }
  static async createLieferantenbestellungenEntry(fields: CreateLieferantenbestellungen): Promise<MutationResult> {
    const data = await callApi('POST', `/apps/${APP_IDS.LIEFERANTENBESTELLUNGEN}/records`, { fields: cleanFieldsForApi(fields as any, 'lieferantenbestellungen') });
    return { ...data, record_id: data.id };
  }
  static async updateLieferantenbestellungenEntry(id: string, fields: Partial<CreateLieferantenbestellungen>): Promise<MutationResult> {
    const data = await callApi('PATCH', `/apps/${APP_IDS.LIEFERANTENBESTELLUNGEN}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'lieferantenbestellungen') });
    return { ...data, record_id: data.id };
  }
  static async deleteLieferantenbestellungenEntry(id: string) {
    return callApi('DELETE', `/apps/${APP_IDS.LIEFERANTENBESTELLUNGEN}/records/${id}`);
  }
  ...
  static async getBestellpositionen(): Promise<Bestellpositionen[]> {
    ...
    return hydrateRecords(records, 'bestellpositionen');
  }
  static async queryBestellpositionen(q: RecordQuery = {}): Promise<Bestellpositionen[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.BESTELLPOSITIONEN}/records${recordQueryString(q)}`, undefined, { signal: q.signal });
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Bestellpositionen[];
  ...
  static async countBestellpositionen(filter?: string, signal?: AbortSignal): Promise<number> {
    const data = await callApi('GET', `/apps/${APP_IDS.BESTELLPOSITIONEN}/aggregate_records${recordQueryString({ filter })}${filter ? '&' : '?'}value=count()`, undefined, { signal, silent: true });
    return parseAggregateCount(data);
  }
  static async getBestellpositionenEntry(id: string): Promise<Bestellpositionen | undefined> {
    ...
    const record = { record_id: data.id, ...data, createdat: data.created_at ?? '', updatedat: data.updated_at ?? null } as Bestellpositionen;
    return hydrateRecords([record], 'bestellpositionen')[0];
  }
  static async createBestellpositionenEntry(fields: CreateBestellpositionen): Promise<MutationResult> {
    const data = await callApi('POST', `/apps/${APP_IDS.BESTELLPOSITIONEN}/records`, { fields: cleanFieldsForApi(fields as any, 'bestellpositionen') });
    return { ...data, record_id: data.id };
  }
  static async updateBestellpositionenEntry(id: string, fields: Partial<CreateBestellpositionen>): Promise<MutationResult> {
    const data = await callApi('PATCH', `/apps/${APP_IDS.BESTELLPOSITIONEN}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'bestellpositionen') });
    return { ...data, record_id: data.id };
  }
  ...
  // --- LAGERBEWEGUNGEN ---
  static async getLagerbewegungen(): Promise<Lagerbewegungen[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.LAGERBEWEGUNGEN}/records`);
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Lagerbewegungen[];
    return hydrateRecords(records, 'lagerbewegungen');
  }
  static async queryLagerbewegungen(q: RecordQuery = {}): Promise<Lagerbewegungen[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.LAGERBEWEGUNGEN}/records${recordQueryString(q)}`, undefined, { signal: q.signal });
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Lagerbewegungen[];
  ...
  static async countLagerbewegungen(filter?: string, signal?: AbortSignal): Promise<number> {
    const data = await callApi('GET', `/apps/${APP_IDS.LAGERBEWEGUNGEN}/aggregate_records${recordQueryString({ filter })}${filter ? '&' : '?'}value=count()`, undefined, { signal, silent: true });
    return parseAggregateCount(data);
  }
  static async getLagerbewegungenEntry(id: string): Promise<Lagerbewegungen | undefined> {
    const data = await callApi('GET', `/apps/${APP_IDS.LAGERBEWEGUNGEN}/records/${id}`);
    const record = { record_id: data.id, ...data, createdat: data.created_at ?? '', updatedat: data.updated_at ?? null } as Lagerbewegungen;
    return hydrateRecords([record], 'lagerbewegungen')[0];
  }
  static async createLagerbewegungenEntry(fields: CreateLagerbewegungen): Promise<MutationResult> {
    const data = await callApi('POST', `/apps/${APP_IDS.LAGERBEWEGUNGEN}/records`, { fields: cleanFieldsForApi(fields as any, 'lagerbewegungen') });
    return { ...data, record_id: data.id };
  }
  static async updateLagerbewegungenEntry(id: string, fields: Partial<CreateLagerbewegungen>): Promise<MutationResult> {
    const data = await callApi('PATCH', `/apps/${APP_IDS.LAGERBEWEGUNGEN}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'lagerbewegungen') });
    return { ...data, record_id: data.id };
  }
  static async deleteLagerbewegungenEntry(id: string) {
    return callApi('DELETE', `/apps/${APP_IDS.LAGERBEWEGUNGEN}/records/${id}`);
  }
  ...
  // --- ZAHLUNGSEINGAENGE ---
  static async getZahlungseingaenge(): Promise<Zahlungseingaenge[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.ZAHLUNGSEINGAENGE}/records`);
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Zahlungseingaenge[];
    return hydrateRecords(records, 'zahlungseingaenge');
  }
  static async queryZahlungseingaenge(q: RecordQuery = {}): Promise<Zahlungseingaenge[]> {
    const data = await callApi('GET', `/apps/${APP_IDS.ZAHLUNGSEINGAENGE}/records${recordQueryString(q)}`, undefined, { signal: q.signal });
    const records = Object.entries(data).map(([id, rec]: [string, any]) => ({
      record_id: id, ...rec,
      createdat: rec.created_at ?? '', updatedat: rec.updated_at ?? null,
    })) as Zahlungseingaenge[];
  ...
  static async countZahlungseingaenge(filter?: string, signal?: AbortSignal): Promise<number> {
    const data = await callApi('GET', `/apps/${APP_IDS.ZAHLUNGSEINGAENGE}/aggregate_records${recordQueryString({ filter })}${filter ? '&' : '?'}value=count()`, undefined, { signal, silent: true });
    return parseAggregateCount(data);
  }
  static async getZahlungseingaengeEntry(id: string): Promise<Zahlungseingaenge | undefined> {
    const data = await callApi('GET', `/apps/${APP_IDS.ZAHLUNGSEINGAENGE}/records/${id}`);
    const record = { record_id: data.id, ...data, createdat: data.created_at ?? '', updatedat: data.updated_at ?? null } as Zahlungseingaenge;
    return hydrateRecords([record], 'zahlungseingaenge')[0];
  }
  static async createZahlungseingaengeEntry(fields: CreateZahlungseingaenge): Promise<MutationResult> {
    const data = await callApi('POST', `/apps/${APP_IDS.ZAHLUNGSEINGAENGE}/records`, { fields: cleanFieldsForApi(fields as any, 'zahlungseingaenge') });
    return { ...data, record_id: data.id };
  }
  static async updateZahlungseingaengeEntry(id: string, fields: Partial<CreateZahlungseingaenge>): Promise<MutationResult> {
    const data = await callApi('PATCH', `/apps/${APP_IDS.ZAHLUNGSEINGAENGE}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'zahlungseingaenge') });
    return { ...data, record_id: data.id };
  }
  static async deleteZahlungseingaengeEntry(id: string) {
    return callApi('DELETE', `/apps/${APP_IDS.ZAHLUNGSEINGAENGE}/records/${id}`);
  }
