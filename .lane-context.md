...
### `lieferanten` — Lieferanten (type `Lieferanten`, one record: `LieferantenEntry`)
Display fields: `firmenname`
- `firmenname` · text · Firmenname · required! · maxLength 4000
- `ansprechpartner_vorname` · text · Ansprechpartner Vorname · maxLength 4000
- `ansprechpartner_nachname` · text · Ansprechpartner Nachname · maxLength 4000
- `strasse` · text · Straße · maxLength 4000
- `hausnummer` · text · Hausnummer · maxLength 4000
- `plz` · text · PLZ · maxLength 4000
...
- `email` · email · E-Mail
- `telefon` · tel · Telefon
- `zahlungsziel_tage` · number · Zahlungsziel (Tage)
- `kreditlimit` · number · Kreditlimit (€) · currency
- `bemerkung` · textarea · Bemerkung

### `artikel` — Artikel (type `Artikel`, one record: `ArtikelEntry`)
...
- `mehrwertsteuersatz` · lookup · Mehrwertsteuersatz · required! · options: mwst_7 | mwst_19
- `lagerbestand` · number · Aktueller Lagerbestand
- `mindestbestand` · number · Mindestbestand
- `lieferant` · record · Lieferant · → `lieferanten`
- `bemerkung` · textarea · Bemerkung
Input shapes: choice `mehrwertsteuersatz` (ChoiceGroup); stock `lagerbestand` (BudgetTracker)
...
- `auftragsdatum` · date · Auftragsdatum · required!
- `lieferdatum` · date · Gewünschtes Lieferdatum
- `kunde` · record · Kunde · required! · → `kunden`
- `status` · lookup · Status · required! · options: entwurf | freigegeben | geliefert | abgerechnet | storniert
- `nettobetrag` · number · Nettobetrag (€) · currency
- `mehrwertsteuerbetrag` · number · Mehrwertsteuerbetrag (€) · currency
...
Display fields: `auftrag`
- `auftrag` · record · Auftrag · required! · → `auftraege`
- `artikel` · record · Artikel · required! · → `artikel`
- `menge` · number · Menge · required!
- `einzelpreis_netto` · number · Einzelpreis netto (€) · currency
- `mehrwertsteuersatz` · lookup · Mehrwertsteuersatz · options: mwst_7 | mwst_19
- `positionsbetrag_netto` · number · Positionsbetrag netto (€) · currency
- `positionsbetrag_brutto` · number · Positionsbetrag brutto (€) · currency
Input shapes: choice `mehrwertsteuersatz` (ChoiceGroup)

### `lieferantenbestellungen` — Lieferantenbestellungen (type `Lieferantenbestellungen`, one record: `LieferantenbestellungenEntry`)
Display fields: `bestellnummer`
- `bestellnummer` · text · Bestellnummer · required! · maxLength 4000
- `bestelldatum` · date · Bestelldatum · required!
- `lieferant` · record · Lieferant · required! · → `lieferanten`
- `status` · lookup · Status · required! · options: offen | bestellt | eingegangen
- `bemerkung` · textarea · Bemerkung
Input shapes: choice `status` (ChoiceGroup)

### `bestellpositionen` — Bestellpositionen (type `Bestellpositionen`, one record: `BestellpositionenEntry`)
Display fields: `bestellung`
- `bestellung` · record · Bestellung · required! · → `lieferantenbestellungen`
- `artikel` · record · Artikel · required! · → `artikel`
- `menge` · number · Menge · required!
- `einkaufspreis` · number · Einkaufspreis (€) · currency

### `lagerbewegungen` — Lagerbewegungen (type `Lagerbewegungen`, one record: `LagerbewegungenEntry`)
Display fields: `bemerkung`
- `bewegungstyp` · lookup · Bewegungstyp · required! · options: wareneingang | warenausgang | korrektur
- `artikel` · record · Artikel · required! · → `artikel`
- `menge` · number · Menge · required!
- `datum` · date · Datum · required!
- `auftrag` · record · Bezug: Auftrag · → `auftraege`
- `bestellung` · record · Bezug: Bestellung · → `lieferantenbestellungen`
- `bemerkung` · textarea · Bemerkung
Input shapes: choice `bewegungstyp` (ChoiceGroup)
...
- `faelligkeitsdatum` · date · Fälligkeitsdatum · required!
- `auftrag` · record · Auftrag · required! · → `auftraege`
- `nettobetrag` · number · Nettobetrag (€) · currency
- `mehrwertsteuerbetrag` · number · Mehrwertsteuerbetrag (€) · currency
- `bruttobetrag` · number · Bruttobetrag (€) · currency
- `status` · lookup · Status · required! · options: offen | bezahlt | ueberfaellig
- `bemerkung` · textarea · Bemerkung
Input shapes: choice `status` (ChoiceGroup)

### `zahlungseingaenge` — Zahlungseingänge (type `Zahlungseingaenge`, one record: `ZahlungseingaengeEntry`)
Display fields: `bemerkung`
- `rechnung` · record · Rechnung · required! · → `rechnungen`
- `zahlungsbetrag` · number · Zahlungsbetrag (€) · required! · currency
- `zahlungsdatum` · date · Zahlungsdatum · required!
- `zahlungsart` · lookup · Zahlungsart · options: lastschrift | bar | sonstige | ueberweisung
- `bemerkung` · textarea · Bemerkung
Input shapes: choice `zahlungsart` (ChoiceGroup)
