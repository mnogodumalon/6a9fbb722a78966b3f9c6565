...
{
  const ENTITY_DIALOG_PASCALS = ["Lieferanten", "Kunden", "Artikel", "Auftraege", "Auftragspositionen", "Lieferantenbestellungen", "Bestellpositionen", "Lagerbewegungen", "Rechnungen", "Zahlungseingaenge"];
  if (usesEntityCrud) {
